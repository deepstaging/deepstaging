...
/// <see cref="LanguageExtTypes"/> from the <c>Deepstaging.Roslyn.LanguageExt</c> satellite package.
/// </summary>
internal static class EffRT
{
    /// <summary><c>Eff&lt;RT, {result}&gt;</c></summary>
    public static EffTypeRef Of(TypeRef result) => LanguageExtTypes.Eff("RT", result);

    /// <summary><c>Eff&lt;RT, List&lt;T&gt;&gt;</c></summary>
    public static readonly EffTypeRef ListT = Of(CollectionTypes.List("T"));

    /// <summary><c>Eff&lt;RT, T[]&gt;</c></summary>
    public static readonly EffTypeRef ArrayT = Of("T[]");

    /// <summary><c>Eff&lt;RT, {result}[]&gt;</c></summary>
    public static EffTypeRef Array(TypeRef result) => LanguageExtTypes.Eff("RT", result: result.Array());

    /// <summary><c>Eff&lt;RT, Option&lt;T&gt;&gt;</c></summary>
    public static readonly EffTypeRef OptionT = Of(LanguageExtTypes.Option("T"));
