...
internal static class TypeConverterWriter
{
    ...
    private static string CanConvertFromBody(TypedIdModel model) =>
    ...
    private static string ConvertFromBody(TypedIdModel model) =>
        model.BackingType switch
        {
            BackingType.Guid => $$"""
                                  return value switch
    ...
    private static string CanConvertToBody(TypedIdModel model) =>
        model.BackingType switch
        {
            BackingType.Guid =>
                """
    ...
    private static string ConvertToBody(TypedIdModel model, PropertyBuilder valueProperty) =>
        model.BackingType switch
        {
            BackingType.Guid => $$"""
