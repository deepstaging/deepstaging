# Deepstaging.Config.Projection

Shared projection layer containing queries and models for extracting attribute data from Roslyn symbols. This project is
the **single source of truth** for attribute interpretation, used by both generators and analyzers.
...
- [RoslynKit.Generators](../Deepstaging.Config.Generators/) - Consumes projections for code generation
- [RoslynKit.Analyzers](../Deepstaging.Config.Analyzers/) - Consumes projections for diagnostics
