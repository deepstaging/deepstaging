...
[TracksFiles(DiagnosticId,
    ...
    MissingMessage = "Class '{0}' has [ConfigProvider] — generate configuration files",
    ...
    StaleMessage = "Configuration files for '{0}' are out of date — regenerate to match current model",
